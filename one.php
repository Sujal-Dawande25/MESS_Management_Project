...
<div class="container">
        <div class="header">
            <h1 class="details-heading">One Time Mess</h1>
...
if (!$conn) {
    ...
    $query = "SELECT o.*, p.verify_payment_status 
              FROM one o 
              LEFT JOIN payment_one p ON o.o_subscription_id = p.o_subscription_id";
    ...
    if (pg_num_rows($result) > 0) {
        ...
        while ($row = pg_fetch_assoc($result)) {
            ...
            if ($row['verify_payment_status'] === 'Verified') {
                ...
                $updateQuery = "UPDATE one SET payment_status = 'Paid' WHERE o_subscription_id = {$row['o_subscription_id']}";
