...
<head>
    ...
    <title>Payment Two Monthly Report</title>
    <link rel="stylesheet" href="details.css"> <!-- Link to your CSS file -->
</head>
<body>
<div class="container">
        <div class="header">
            <h1 class="details-heading">Payment Two Monthly Report</h1>
            ...
            <tbody>
               ...
               include 'connection.php';
                ...
                if (!$conn) {
                    ...
                    // Query to fetch monthly total amounts from the 'payment_two' table
                    $query = "SELECT TO_CHAR(DATE_TRUNC('month', t_date_of_payment), 'Mon YYYY') AS month_name, SUM(t_amount) AS total_amount 
                              FROM payment_two 
                              GROUP BY DATE_TRUNC('month', t_date_of_payment) 
                              ORDER BY DATE_TRUNC('month', t_date_of_payment)";
